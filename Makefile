...
all:
	...
	@$(CC) $(CFLAGS) source/base/webserver.c source/base/evilnetlib.c source/base/config.c  source/libraries/jsmn/libjsmn.a -o build/evilwebserver > build/build.log 2>&1
	@cp scripts build/ -r
	@cp config build/ -r
